import { Et as parseAbi, Kt as formatAbiItem$1, Xt as keccak_256, tt as __vitePreload } from "./index-COKBVXd7.js";
...
async function call(client, args) {
	...
	try {
		...
		const { offchainLookup: offchainLookup$1, offchainLookupSignature: offchainLookupSignature$1 } = await __vitePreload(async () => {
			const { offchainLookup: offchainLookup$2, offchainLookupSignature: offchainLookupSignature$2 } = await import("./ccip-Du3vDJLr.js");
			return {
