const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/_esm-BnAMENiB.js","assets/index-DTDIO01R.js","assets/index-WXg7UE4q.css","assets/secp256k1-C0rbGAYv.js","assets/_esm-i5Ili2n0.js","assets/ccip-CQ8DTX2Z.js"])))=>i.map(i=>d[i]);
import { tt as __vitePreload } from "./index-DTDIO01R.js";
import { C as erc20Abi, gn as formatUnits } from "./ccip-CQ8DTX2Z.js";
...
async function loadViemUtils() {
	if (!cachedViemUtils) {
		const { createPublicClient, http, defineChain } = await __vitePreload(async () => {
			const { createPublicClient: createPublicClient$1, http: http$1, defineChain: defineChain$1 } = await import("./_esm-BnAMENiB.js");
			return {
