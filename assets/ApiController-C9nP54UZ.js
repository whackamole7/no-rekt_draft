const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/_esm-BvKPcFPh.js","assets/index-Cbctl4IR.js","assets/index-BkyzoR8L.css","assets/secp256k1-CAcp7pC4.js","assets/_esm-Bme02ub9.js","assets/ccip-h0Mu6wSz.js"])))=>i.map(i=>d[i]);
import { tt as __vitePreload } from "./index-Cbctl4IR.js";
import { C as erc20Abi, gn as formatUnits } from "./ccip-h0Mu6wSz.js";
...
async function loadViemUtils() {
	if (!cachedViemUtils) {
		const { createPublicClient, http, defineChain } = await __vitePreload(async () => {
			const { createPublicClient: createPublicClient$1, http: http$1, defineChain: defineChain$1 } = await import("./_esm-BvKPcFPh.js");
			return {
