const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/_esm-mPeYTGmr.js","assets/index-C8lSdra8.js","assets/index-BW7cINCs.css","assets/secp256k1-CrSN2pxT.js","assets/_esm-DQNRVWAZ.js","assets/ccip-2SMp6R5f.js"])))=>i.map(i=>d[i]);
import { tt as __vitePreload } from "./index-C8lSdra8.js";
import { C as erc20Abi, gn as formatUnits } from "./ccip-2SMp6R5f.js";
...
async function loadViemUtils() {
	if (!cachedViemUtils) {
		const { createPublicClient, http, defineChain } = await __vitePreload(async () => {
			const { createPublicClient: createPublicClient$1, http: http$1, defineChain: defineChain$1 } = await import("./_esm-mPeYTGmr.js");
			return {
