const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/_esm-BEQ5GKea.js","assets/index-C4TMBonS.js","assets/index-D9vt620a.css","assets/secp256k1-C-f1d_3v.js","assets/_esm-DlQFvn0o.js","assets/ccip-DjZvt_NB.js"])))=>i.map(i=>d[i]);
import { c as __vitePreload } from "./index-C4TMBonS.js";
import { C as erc20Abi, gn as formatUnits } from "./ccip-DjZvt_NB.js";
...
async function loadViemUtils() {
	if (!cachedViemUtils) {
		const { createPublicClient, http, defineChain } = await __vitePreload(async () => {
			const { createPublicClient: createPublicClient$1, http: http$1, defineChain: defineChain$1 } = await import("./_esm-BEQ5GKea.js");
			return {
