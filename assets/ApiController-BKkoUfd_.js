const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/_esm-CSqaAMi4.js","assets/index-DCFzP3dW.js","assets/index-BW7cINCs.css","assets/secp256k1-DyEezgZf.js","assets/_esm-qLvW6wfW.js","assets/ccip-DWRUUg-Y.js"])))=>i.map(i=>d[i]);
import { tt as __vitePreload } from "./index-DCFzP3dW.js";
import { C as erc20Abi, gn as formatUnits } from "./ccip-DWRUUg-Y.js";
...
async function loadViemUtils() {
	if (!cachedViemUtils) {
		const { createPublicClient, http, defineChain } = await __vitePreload(async () => {
			const { createPublicClient: createPublicClient$1, http: http$1, defineChain: defineChain$1 } = await import("./_esm-CSqaAMi4.js");
			return {
