...
var q = `wc@2:ethereum_provider:`, U = "https://rpc.walletconnect.org/v1/", f = ["eth_sendTransaction", "personal_sign"], A = [
	...
	const { createAppKit: s } = await __vitePreload(async () => {
		const { createAppKit: s$1 } = await import("./core-BzVLaXwD.js");
