const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/_esm-CNkHRVZR.js","assets/index-CcbBBlPf.js","assets/index-D9vt620a.css","assets/secp256k1-DQbwaQZ3.js","assets/_esm-DqHDbtLE.js","assets/ccip-DUYOAizV.js"])))=>i.map(i=>d[i]);
import { c as __vitePreload } from "./index-CcbBBlPf.js";
import { C as erc20Abi, gn as formatUnits } from "./ccip-DUYOAizV.js";
...
async function loadViemUtils() {
	if (!cachedViemUtils) {
		const { createPublicClient, http, defineChain } = await __vitePreload(async () => {
			const { createPublicClient: createPublicClient$1, http: http$1, defineChain: defineChain$1 } = await import("./_esm-CNkHRVZR.js");
			return {
