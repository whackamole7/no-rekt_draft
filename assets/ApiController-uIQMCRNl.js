const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/_esm-C2fgLlXn.js","assets/index-D9nRC1Zc.js","assets/index-DWeiJWyd.css","assets/secp256k1-EXvBHXU9.js","assets/_esm-B6WM_OSW.js","assets/ccip-DRisnTxm.js"])))=>i.map(i=>d[i]);
import { tt as __vitePreload } from "./index-D9nRC1Zc.js";
import { C as erc20Abi, gn as formatUnits } from "./ccip-DRisnTxm.js";
...
async function loadViemUtils() {
	if (!cachedViemUtils) {
		const { createPublicClient, http, defineChain } = await __vitePreload(async () => {
			const { createPublicClient: createPublicClient$1, http: http$1, defineChain: defineChain$1 } = await import("./_esm-C2fgLlXn.js");
			return {
