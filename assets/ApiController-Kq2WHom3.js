const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/_esm-BEUUgEAm.js","assets/index-Chby2Mwr.js","assets/index-DFFvNLBS.css","assets/secp256k1-ydkiuIq4.js","assets/_esm-T_ZBm6-9.js","assets/ccip-DqkwjF9C.js"])))=>i.map(i=>d[i]);
import { tt as __vitePreload } from "./index-Chby2Mwr.js";
import { C as erc20Abi, gn as formatUnits } from "./ccip-DqkwjF9C.js";
...
async function loadViemUtils() {
	if (!cachedViemUtils) {
		const { createPublicClient, http, defineChain } = await __vitePreload(async () => {
			const { createPublicClient: createPublicClient$1, http: http$1, defineChain: defineChain$1 } = await import("./_esm-BEUUgEAm.js");
			return {
