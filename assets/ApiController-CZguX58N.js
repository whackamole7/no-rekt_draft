const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/_esm-BhRrR2eo.js","assets/index-D8VKH8xI.js","assets/index-BkyzoR8L.css","assets/secp256k1-DixscjM7.js","assets/_esm-BNbhIrv6.js","assets/ccip-CTRz-Td5.js"])))=>i.map(i=>d[i]);
import { tt as __vitePreload } from "./index-D8VKH8xI.js";
import { C as erc20Abi, gn as formatUnits } from "./ccip-CTRz-Td5.js";
...
async function loadViemUtils() {
	if (!cachedViemUtils) {
		const { createPublicClient, http, defineChain } = await __vitePreload(async () => {
			const { createPublicClient: createPublicClient$1, http: http$1, defineChain: defineChain$1 } = await import("./_esm-BhRrR2eo.js");
			return {
