...
var Z = Object.defineProperty, g = Object.getOwnPropertyDescriptor, e = (r, o, p$1, s$1) => {
	for (var t = s$1 > 1 ? void 0 : s$1 ? g(o, p$1) : o, l = r.length - 1, m; l >= 0; l--) (m = r[l]) && (t = (s$1 ? m(o, p$1, t) : m(t)) || t);
	return s$1 && t && Z(o, p$1, t), t;
};
var h = class extends n {
    ...
    >
      ${h.weightsMap.get((r = this.weight) != null ? r : "regular")}
    </svg>`;
	}
};
h.weightsMap = /* @__PURE__ */ new Map([
...
e([O({
	type: Boolean,
	reflect: !0
})], h.prototype, "mirrored", 2);
h = e([s("ph-currency-dollar")], h);
export { h as PhCurrencyDollar };
